/**
 * GitHub "Source" link for the editor header (icon-only).
 * Sits in the right gutter of the brand lockup.
 */
export function GithubMark({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 16 16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
        fillRule="evenodd"
        clipRule="evenodd"
...
export function SourceLink({ repoUrl }: { repoUrl: string }) {
  return (
    <a
